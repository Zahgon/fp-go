...
func (builder *Builder) GetTargetUrl() Result[string] { _ = "STUB: not implemented"; return nil }
...
func (builder *Builder) GetBody() Option[Result[[]byte]] { _ = "STUB: not implemented"; return nil }
...
func Header(name string) Lens[*Builder, Option[string]] { _ = "STUB: not implemented"; return nil }
...
func QueryArg(name string) Lens[*Builder, Option[string]] { _ = "STUB: not implemented"; return nil }
