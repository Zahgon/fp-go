...
func Ap[B, A any](fa A, faerr error) Operator[func(A) B, B] { _ = "STUB: not implemented"; return nil }
...
func ChainTo[A, B any](b B, berr error) Operator[A, B] { _ = "STUB: not implemented"; return nil }
...
func FromNillable[A any](e error) Kleisli[*A, *A] { _ = "STUB: not implemented"; return nil }
...
func GetOrElse[A any](onLeft func(error) A) func(A, error) A { _ = "STUB: not implemented"; return nil }
...
func Alt[A any](that func() (A, error)) Operator[A, A] { _ = "STUB: not implemented"; return nil }
