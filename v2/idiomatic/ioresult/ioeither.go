...
func FromResult[A any](a A, err error) IOResult[A] { _ = "STUB: not implemented"; return nil }
...
func FromImpure(f func()) IOResult[Void] { _ = "STUB: not implemented"; return nil }
