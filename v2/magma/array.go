...
func MonadConcatAll[A any](m Magma[A]) func([]A, A) A { _ = "STUB: not implemented"; return nil }

// ConcatAll concats all items using the semigroup and a starting value
func ConcatAll[A any](m Magma[A]) func(A) func([]A) A { _ = "STUB: not implemented"; return nil }
