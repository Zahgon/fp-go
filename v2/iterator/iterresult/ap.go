...
//
// If either sequence contains a Left, the error is propagated.
func ApFirst[A, B any](second SeqResult[B]) Operator[A, A] { _ = "STUB: not implemented"; return nil }
...
//
// If either sequence contains a Left, the error is propagated.
func ApSecond[A, B any](second SeqResult[B]) Operator[A, B] { _ = "STUB: not implemented"; return nil }
