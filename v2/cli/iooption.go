...
func generateIOOptionSequenceT(f *os.File, i int) { _ = "STUB: not implemented"; return }

func generateIOOptionSequenceTuple(f *os.File, i int) { _ = "STUB: not implemented"; return }

func generateIOOptionTraverseTuple(f *os.File, i int) { _ = "STUB: not implemented"; return }
