...
func generateIOSequenceT(f *os.File, i int) { _ = "STUB: not implemented"; return }

func generateIOSequenceTuple(f *os.File, i int) { _ = "STUB: not implemented"; return }

func generateIOTraverseTuple(f *os.File, i int) { _ = "STUB: not implemented"; return }
