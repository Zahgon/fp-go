...
//
//go:inline
func Right[R, A any](a A) ReaderReaderIOResult[R, A] { _ = "STUB: not implemented"; return nil }

// Left creates a ReaderReaderIOResult that fails with the given error.
// This is the failure constructor for the Result type.
//
//go:inline
func Left[R, A any](e error) ReaderReaderIOResult[R, A] { _ = "STUB: not implemented"; return nil }

// Of creates a ReaderReaderIOResult that succeeds with the given value (Pointed operation).
// Alias for Right.
//
//go:inline
func Of[R, A any](a A) ReaderReaderIOResult[R, A] { _ = "STUB: not implemented"; return nil }
...
//
//go:inline
func RightIO[R, A any](ma IO[A]) ReaderReaderIOResult[R, A] { _ = "STUB: not implemented"; return nil }
...
//
//go:inline
func FromIO[R, A any](ma IO[A]) ReaderReaderIOResult[R, A] { _ = "STUB: not implemented"; return nil }
...
//
//go:inline
func Ask[R any]() ReaderReaderIOResult[R, R] { _ = "STUB: not implemented"; return nil }
