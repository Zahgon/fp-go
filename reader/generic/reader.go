...
func Asks[GA ~func(R) A, R, A any](f GA) GA { _ = "STUB: not implemented"; return *new(GA) }
...
func Of[GA ~func(R) A, R, A any](a A) GA { _ = "STUB: not implemented"; return *new(GA) }
...
func Read[GA ~func(E) A, E, A any](e E) func(GA) A { _ = "STUB: not implemented"; return nil }
